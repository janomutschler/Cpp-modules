...
Overview
    ...
    CPP08 flips that around and forces you to think in terms of generic code,
    iterators, and standard containers instead of reinventing the wheel.
  
    The main takeaway for me was understanding how 
    templates + STL containers + iterators work together
    , and how powerful that combination is when used correctly.
